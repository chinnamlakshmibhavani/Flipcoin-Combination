...
winner singlet_combinations singlet_combination_percentages
echo 
echo "For Doublet Combination"
winner doublet_combinations doublet_combination_percentages
echo

echo "For Triplet Combination"
winner triplet_combinations triplet_combination_percentages
echo

echo "For All Combinations"
winner total_combinations total_combination_percentages
